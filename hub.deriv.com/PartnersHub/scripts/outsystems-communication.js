(function(global, factory) {
    ...
    var se,
        ...
        ce = function e(t) {
            var o;
            if ("%AsyncFunction%" === t) o = V("async function () {}");
            else if ("%GeneratorFunction%" === t) o = V("function* () {}");
            else if ("%AsyncGeneratorFunction%" === t) o = V("async function* () {}");
        ...
        be = function(e, t) {
            ...
            for (var l = 1, u = !0; l < o.length; l += 1) {
                ...
                if ("constructor" !== h && u || (a = !0), he(ne, i = "%" + (r += "." + h) + "%")) s = ne[i];
                else if (null != s) {
                    if (!(h in s)) {
    ...
    function Ut(e, t) {
        ...
        if ("function" == typeof dt)
            for (var l = 0; l < s.length; l++) mt.call(e, s[l]) && r.push("[" + t(s[l]) + "]: " + t(e[s[l]], e));
        return r;
    }
    var Mt = be,
        Wt = function(e, t) {
        ...
        Nt = function e(t, o, r, n) {
            ...
            if (void 0 === n) n = [];
            else if (jt(n, t) >= 0) return "[Circular]";
        ...
        Xt = function(e, t) {
            for (var o, r = e; null !== (o = r.next); r = o)
                if (o.key === t) return r.next = o.next, o.next = e.next, e.next = o, o;
        },
        ...
        co = {
            ...
            compact: function(e) {
                for (var t = [{
                    ...
                    for (var n = t[r], i = n.obj[n.prop], s = Object.keys(i), a = 0; a < s.length; ++a) {
                        var c = s[a],
                            l = i[c];
        ...
        Ro = function(e, t, o, r) {
            if (e) {
                ...
                return s && c.push("[" + n.slice(s.index) + "]"),
                    function(e, t, o, r) {
                        for (var n = r ? t : Po(t, o), i = e.length - 1; i >= 0; --i) {
                            var s,
                                a = e[i];
                            if ("[]" === a && o.parseArrays) s = o.allowEmptyArrays && ("" === n || o.strictNullHandling && null === n) ? [] : [].concat(n);
                            else {
        ...
        jo = function(e, t) {
            ...
            for (var r = "string" == typeof e ? function(e, t) {
                    ...
                    if (t.charsetSentinel)
                        for (n = 0; n < s.length; ++n) 0 === s[n].indexOf("utf8=") && ("utf8=%E2%9C%93" === s[n] ? c = "utf-8" : "utf8=%26%2310003%3B" === s[n] && (c = "iso-8859-1"), a = n, n = s.length);
    ...
    class cn extends Nr {
        constructor(e) {
            if (super(), "undefined" != typeof fetch || Kr.isNode) this._httpClient = new nn(e);
            else {
    ...
    class En {
        ...
        async _createTransport(e, t, o, r) {
            ...
            for (const o of s) {
                ...
                if (s instanceof Error) i.push(`${o.transport} failed:`), i.push(s);
    ...
    class Rn {
        configureLogging(e) {
            if (zr.isRequired(e, "logging"), void 0 !== e.log) this.logger = e;
