...
function(e) {
    ...
    function s(t, s, r, i) {
        t.hasOwnProperty(s) || (t[s] = i.apply(null, r), "function" == typeof CustomEvent && e.win.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
            detail: {
                path: s,
                module: t[s]
            }
        ...
        class v {
            ...
            getColumnDistribution() {
                ...
                (e && e.series || []).forEach(e => {
                    ...
                    let s = new R,
                        ...
                        c = i(u.type || a),
                        p = c || ["y"];
                    for ((m(t.x) || u.isCartesian || !c) && s.addColumnReader(t.x, "x"), C(t, function(e, t) {
                            "x" !== t && s.addColumnReader(e, t)
                        }), h = 0; h < l; h++) s.hasReader(p[h]) || s.addColumnReader(void 0, p[h]);
                    o.push(s), d++
                });
                let c = i(a);
            ...
            parseCSV(e) {
                ...
                if (l && r.beforeParse && (l = r.beforeParse.call(this, l)), l) {
                    if (m = l.replace(/\r\n/g, "\n").replace(/\r/g, "\n").split(r.lineDelimiter || "\n"), (!d || d < 0) && (d = 0), (!u || u >= m.length) && (u = m.length - 1), r.itemDelimiter) h = r.itemDelimiter;
                    else {
                        let e, s, i;
                        h = null, e = 0, s = 0, i = !1, m.some(function(t, r) {
                            let i = !1,
                                a, n, l, d = "";
                            if (r > 13) return !0;
                            for (let r = 0; r < t.length; r++) {
                                ...
                                } else void 0 !== o[a] ? (isNaN(Date.parse(d = d.trim())) ? (isNaN(d) || !isFinite(d)) && o[a]++ : o[a]++, d = "") : d += a;
                                "," === a && s++, "." === a && e++
                            }
                        }), o[";"] > o[","] ? i = ";" : (o[","], o[";"], i = ","), r.decimalPoint || (e > s ? r.decimalPoint = "." : r.decimalPoint = ",", t.decimalRegex = RegExp("^(-?[0-9]+)" + r.decimalPoint + "([0-9]+)$")), h = i
                    }
                    let e = 0;
                    for (c = d; c <= u; c++) "#" === m[c][0] ? e++ : function(e, t, o, l) {
                        let d = 0,
                            u = "",
                            m = "",
                            c = "",
                        ...
                        if (e.trim().length && "#" !== e.trim()[0]) {
                            for (; d < e.length; d++)
                                if (C(d), '"' === u)
                                    for (C(++d); d < e.length && ('"' !== u || '"' === m || '"' === c);)('"' !== u || '"' === u && '"' !== m) && (p += u), C(++d);
                                else u === h ? y() : p += u;
                            y()
                        }
                    }(m[c], c - d - e);
                    (!r.columnTypes || 0 === r.columnTypes.length) && n.length && n[0].length && "date" === n[0][1] && !r.dateFormat && (r.dateFormat = function(e, s) {
                        ...
                        for ((!s || s > e.length) && (s = e.length); u < s; u++)
                            if (void 0 !== e[u] && e[u] && e[u].length)
                                for (m = 0, o = e[u].trim().replace(/\//g, " ").replace(/\-/g, " ").replace(/\./g, " ").split(" "), l = ["", "", ""]; m < o.length; m++) m < l.length && (o[m] = parseInt(o[m], 10), o[m] && (n[m] = !n[m] || n[m] < o[m] ? o[m] : n[m], void 0 !== a[m] ? a[m] !== o[m] && (a[m] = !1) : a[m] = o[m], o[m] > 31 ? o[m] < 100 ? l[m] = "YY" : l[m] = "YYYY" : o[m] > 12 && o[m] <= 31 ? (l[m] = "dd", h = !0) : l[m].length || (l[m] = "mm")));
                        if (h) {
                            for (m = 0; m < a.length; m++) !1 !== a[m] ? n[m] > 12 && "YY" !== l[m] && "YYYY" !== l[m] && (l[m] = "YY") : n[m] > 12 && "mm" === l[m] && (l[m] = "dd");
                            return (3 === l.length && "dd" === l[1] && "dd" === l[2] && (l[2] = "YY"), d = l.join("/"), (r.dateFormats || t.dateFormats)[d]) ? d : (p("deduceDateFailed"), i)
                        }
                        return i
                    }(s[0])), this.dataFound()
                }
            ...
            fetchLiveData() {
                ...
                return !!T(s) && (n < 1e3 && (n = 1e3), delete s.csvURL, delete s.rowsURL, delete s.columnsURL, function o(l) {
                    function u(i, u, h) {
                        ...
                        return l && (clearTimeout(e.liveDataTimeout), t.liveDataURL = i), d({
                            url: i,
                            dataType: h || "json",
                            success: function(e) {
                                t && t.series && u(e), m()
                    ...
                    u(i.csvURL, function(e) {
                        t.update({
                            data: {
                                csv: e
                            }
                        })
                    }, "text") || u(i.rowsURL, function(e) {
                        t.update({
                            data: {
                                rows: e
                            }
            ...
            parseColumn(e, t) {
                let s = this.rawColumns,
                    ...
                    d = a && o && o.xAxis && "category" === y(o.xAxis)[0].type || "string" === l,
                    u = m(e.name),
                    h = e.length,
                    c, p, g, C, x, T, v;
                for (s[t] || (s[t] = []); h--;) c = n[h] || e[h], g = this.trim(c), p = parseFloat(C = this.trim(c, !0)), void 0 === s[t][h] && (s[t][h] = g), d || 0 === h && i && !u ? e[h] = "" + g : +C === p ? (e[h] = p, p > 31536e6 && "float" !== l ? e.isDatetime = !0 : e.isNumeric = !0, void 0 !== e[h + 1] && (v = p > e[h + 1])) : (g && g.length && (x = this.parseDate(c)), a && f(x) && "float" !== l ? (n[h] = c, e[h] = x, e.isDatetime = !0, void 0 !== e[h + 1] && ((T = x > e[h + 1]) !== v && void 0 !== v && (this.alternativeFormat ? (this.dateFormat = this.alternativeFormat, h = e.length, this.alternativeFormat = this.dateFormats[this.dateFormat].alternative) : e.unsorted = !0), v = T)) : (e[h] = "" === g ? null : g, 0 !== h && (e.isDatetime || e.isNumeric) && (e.mixed = !0)));
            ...
            complete() {
                ...
                if ([].length = c.length, p.complete || p.afterComplete) {
                    ...
                    for (n = 0, t = [], d = function(e, t) {
                            ...
                            return n
                        }(c.length, this.valueCount.seriesBuilders); n < this.valueCount.seriesBuilders.length; n++)(l = this.valueCount.seriesBuilders[n]).populateColumns(d) && f.push(l);
                    for (; d.length > 0;) {
                        for ((l = new R).addColumnReader(0, "x"), -1 !== (h = d.indexOf(0)) && d.splice(h, 1), r = 0; r < this.valueCount.global; r++) l.addColumnReader(void 0, this.valueCount.globalPointArrayMap[r]);
                        l.populateColumns(d) && f.push(l)
                    }
                    if (f.length > 0 && f[0].readers.length > 0 && void 0 !== (u = c[f[0].readers[0].columnIndex]) && (u.isDatetime ? e = "datetime" : u.isNumeric || (e = "category")), "category" === e)
