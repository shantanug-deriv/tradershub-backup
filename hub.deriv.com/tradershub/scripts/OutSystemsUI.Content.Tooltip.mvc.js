    ...
    var OS = OSRuntimeCore; {
        ...
        OS.Controller.BaseViewController {
                        ...
                        return OS.Logger.startActiveSpan("RegisterCallbacks", function(span) {
                            ...
                            try {
                                ...
                                getCallbackHandlersJSResult.value = OS.Logger.startActiveSpan("GetCallbackHandlers", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(OutSystemsUI_Content_Tooltip_mvc_controller_RegisterCallbacks_GetCallbackHandlersJS, "GetCallbackHandlers", "RegisterCallbacks", {
            ...
            get _onToggleHandler$Action() {
                if (!(this.hasOwnProperty("__onToggleHandler$Action"))) {
            ...
            set _onToggleHandler$Action(value) {
                this.__onToggleHandler$Action = value;
            }
            ...
            get onToggle$Action() {
                if (!(this.hasOwnProperty("_onToggle$Action"))) {
            ...
            set onToggle$Action(value) {
                this._onToggle$Action = value;
            }
