            ...
            try {
                ...
                if (((vars.value.consoleErrorTypeIdInLocal === BrowserConsoleLoggingModel.staticEntities.consoleErrorType.warning))) {
                    OS.Logger.startActiveSpan("ConsoleWarning", function(span) {
                        ...
                        try {
                            return controller.safeExecuteJSNode(BrowserConsoleLogging_controller_ConsoleLog_ConsoleWarningJS, "ConsoleWarning", "ConsoleLog", {
                    ...
                    if ((vars.value.consoleErrorTypeIdInLocal === BrowserConsoleLoggingModel.staticEntities.consoleErrorType.error)) {
                        OS.Logger.startActiveSpan("ConsoleError", function(span) {
                            ...
                            try {
                                return controller.safeExecuteJSNode(BrowserConsoleLogging_controller_ConsoleLog_ConsoleErrorJS, "ConsoleError", "ConsoleLog", {
                                    Message: OS.DataConversion.JSNodeParamConverter.to(vars.value.messageInLocal, OS.DataTypes.DataTypes.Text)
                                }, function($parameters) {}, {}, {});
                            } finally {
                                if (span) {
                        ...
                        if ((vars.value.consoleErrorTypeIdInLocal === BrowserConsoleLoggingModel.staticEntities.consoleErrorType.information)) {
                            OS.Logger.startActiveSpan("ConsoleLog", function(span) {
                                ...
                                try {
                                    return controller.safeExecuteJSNode(BrowserConsoleLogging_controller_ConsoleLog_ConsoleLogJS, "ConsoleLog", "ConsoleLog", {
                                        Message: OS.DataConversion.JSNodeParamConverter.to(vars.value.messageInLocal, OS.DataTypes.DataTypes.Text)
                                    }, function($parameters) {}, {}, {});
                                } finally {
                                    if (span) {
            ...
            try {
                ...
                if (((vars.value.consoleErrorTypeIdInLocal === BrowserConsoleLoggingModel.staticEntities.consoleErrorType.warning))) {
                    OS.Logger.startActiveSpan("ConsoleWarning", function(span) {
                        ...
                        try {
                            return controller.safeExecuteJSNode(BrowserConsoleLogging_controller_ConsoleLogWithJSON_ConsoleWarningJS, "ConsoleWarning", "ConsoleLogWithJSON", {
                    ...
                    if ((vars.value.consoleErrorTypeIdInLocal === BrowserConsoleLoggingModel.staticEntities.consoleErrorType.error)) {
                        OS.Logger.startActiveSpan("ConsoleError", function(span) {
                            ...
                            try {
                                return controller.safeExecuteJSNode(BrowserConsoleLogging_controller_ConsoleLogWithJSON_ConsoleErrorJS, "ConsoleError", "ConsoleLogWithJSON", {
                                    JSON: OS.DataConversion.JSNodeParamConverter.to(vars.value.jSONInLocal, OS.DataTypes.DataTypes.Text),
                                    Message: OS.DataConversion.JSNodeParamConverter.to(vars.value.messageInLocal, OS.DataTypes.DataTypes.Text)
                                }, function($parameters) {}, {}, {});
                            } finally {
                        ...
                        if ((vars.value.consoleErrorTypeIdInLocal === BrowserConsoleLoggingModel.staticEntities.consoleErrorType.information)) {
                            OS.Logger.startActiveSpan("ConsoleLog", function(span) {
                                ...
                                try {
                                    return controller.safeExecuteJSNode(BrowserConsoleLogging_controller_ConsoleLogWithJSON_ConsoleLogJS, "ConsoleLog", "ConsoleLogWithJSON", {
                                        JSON: OS.DataConversion.JSNodeParamConverter.to(vars.value.jSONInLocal, OS.DataTypes.DataTypes.Text),
                                        Message: OS.DataConversion.JSNodeParamConverter.to(vars.value.messageInLocal, OS.DataTypes.DataTypes.Text)
                                    }, function($parameters) {}, {}, {});
                                } finally {
