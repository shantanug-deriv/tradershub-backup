...
try {return controller.safeExecuteJSNode(tradershub_Signup_SocialLogin_mvc_controller_OnReady_InitGooglePlatformJS, "InitGooglePlatform", "OnReady", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
