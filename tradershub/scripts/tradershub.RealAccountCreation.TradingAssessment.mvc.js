...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_TradingAssessment_mvc_controller_OnReady_RudderStackJS, "RudderStack", "OnReady", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_TradingAssessment_mvc_controller_NextOnClick_RudderStackJS, "RudderStack", "NextOnClick", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
