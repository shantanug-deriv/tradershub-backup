...
isDefault: false,
onClick: function () {
try {OS.Navigation.navigateTo(OS.Navigation.generateScreenURL("tradershub", "citizenship2", {}), OS.Transitions.createTransition(OS.Transitions.TransitionAnimation.Fade), null, true);
} catch (ex) {
...
try {return controller.safeExecuteJSNode(tradershub_Signup_CountryOfResidence2_mvc_controller_OnReady_GetCurrentResidenceBasedOnWebsiteStatusJS, "GetCurrentResidenceBasedOnWebsiteStatus", "OnReady", {
