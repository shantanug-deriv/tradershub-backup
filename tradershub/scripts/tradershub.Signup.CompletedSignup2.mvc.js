...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "Signup.CompletedSignup2"; }
...
isDefault: false,
onClick: function () {
try {OS.Navigation.navigateTo(OS.Navigation.generateScreenURL("https://app.deriv.com", {}), OS.Transitions.createTransition(OS.Transitions.TransitionAnimation.Default), null, true);
} catch (ex) {
...
try {return controller.safeExecuteJSNode(tradershub_Signup_CompletedSignup2_mvc_controller_OnInitialize_ParseURLJS, "ParseURL", "OnInitialize", {
...
get _buttonOnClickRealAccount$Action() {if(!(this.hasOwnProperty("__buttonOnClickRealAccount$Action"))) {
...
try {return controller.safeExecuteJSNode(tradershub_Signup_CompletedSignup2_mvc_controller_ButtonOnClickRealAccount_RudderStackJS, "RudderStack", "ButtonOnClickRealAccount", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteJSNode(tradershub_Signup_CompletedSignup2_mvc_controller_ButtonOnClickRealAccount_LandingCompanyPayloadJS, "LandingCompanyPayload", "ButtonOnClickRealAccount", {
...
}set _buttonOnClickRealAccount$Action(value) {this.__buttonOnClickRealAccount$Action = value;
}
...
try {return controller.safeExecuteJSNode(tradershub_Signup_CompletedSignup2_mvc_controller_OnReady_AuthorizePayloadJS, "AuthorizePayload", "OnReady", {
...
try {return controller.safeExecuteJSNode(tradershub_Signup_CompletedSignup2_mvc_controller_OnReady_CheckLandingCompanyJS, "CheckLandingCompany", "OnReady", {
...
try {return controller.safeExecuteJSNode(tradershub_Signup_CompletedSignup2_mvc_controller_OnReady_SetAccountSettingsPayloadJS, "SetAccountSettingsPayload", "OnReady", {
...
try {return controller.safeExecuteJSNode(tradershub_Signup_CompletedSignup2_mvc_controller_OnReady_SyncLocalStorageJS, "SyncLocalStorage", "OnReady", {
...
try {return controller.safeExecuteJSNode(tradershub_Signup_CompletedSignup2_mvc_controller_OnReady_GetIDVCountryJS, "GetIDVCountry", "OnReady", {
...
try {return controller.safeExecuteJSNode(tradershub_Signup_CompletedSignup2_mvc_controller_OnReady_LandingCompanyPayloadJS, "LandingCompanyPayload", "OnReady", {
CountryCode: OS.DataConversion.JSNodeParamConverter.to(tradershubClientVariables.getSelectedResidence(), OS.DataTypes.DataTypes.Text),
Payload: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
