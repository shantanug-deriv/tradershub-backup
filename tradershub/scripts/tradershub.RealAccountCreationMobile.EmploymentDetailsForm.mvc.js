...
try {controller.ensureControllerAlive("CountryOfTaxResidenceSelectorOnClickCountry");
...
try {return controller.safeExecuteClientAction(controller._countryOfTaxResidenceSelectorOnClickCountry$Action, callContext, residenceIn, labelIn);
} finally {
if(span) {
span.end();
}
