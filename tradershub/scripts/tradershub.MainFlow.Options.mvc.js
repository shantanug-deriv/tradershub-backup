...
get _turbosRedirection$Action() {if(!(this.hasOwnProperty("__turbosRedirection$Action"))) {
...
try {controller.ensureControllerAlive("TurbosRedirection");
...
}set _turbosRedirection$Action(value) {this.__turbosRedirection$Action = value;
}

get _redirectToTrustPilot$Action() {if(!(this.hasOwnProperty("__redirectToTrustPilot$Action"))) {
...
try {controller.ensureControllerAlive("RedirectToTrustPilot");
callContext = controller.callContext(callContext);
// Destination: /tradershub/
...
}set _redirectToTrustPilot$Action(value) {this.__redirectToTrustPilot$Action = value;
}
...
get _toggleEmptyPlatformModal$Action() {if(!(this.hasOwnProperty("__toggleEmptyPlatformModal$Action"))) {
...
try {controller.ensureControllerAlive("ToggleEmptyPlatformModal");
callContext = controller.callContext(callContext);
...
}set _toggleEmptyPlatformModal$Action(value) {this.__toggleEmptyPlatformModal$Action = value;
}

get _androidDGoRedirection$Action() {if(!(this.hasOwnProperty("__androidDGoRedirection$Action"))) {
...
try {controller.ensureControllerAlive("AndroidDGoRedirection");
callContext = controller.callContext(callContext);
// Destination: /tradershub/
...
}set _androidDGoRedirection$Action(value) {this.__androidDGoRedirection$Action = value;
}
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_Options_mvc_controller_OnReady_JavaScript2JS, "JavaScript2", "OnReady", {
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_Options_mvc_controller_OnReady_JavaScript1JS, "JavaScript1", "OnReady", {
...
get _accumulatorsRedirection$Action() {if(!(this.hasOwnProperty("__accumulatorsRedirection$Action"))) {
...
try {controller.ensureControllerAlive("AccumulatorsRedirection");
callContext = controller.callContext(callContext);
// Destination: /tradershub/
...
}set _accumulatorsRedirection$Action(value) {this.__accumulatorsRedirection$Action = value;
}
...
get _iOSDGoRedirection$Action() {if(!(this.hasOwnProperty("__iOSDGoRedirection$Action"))) {
...
try {controller.ensureControllerAlive("IOSDGoRedirection");
callContext = controller.callContext(callContext);
// Destination: /tradershub/
...
}set _iOSDGoRedirection$Action(value) {this.__iOSDGoRedirection$Action = value;
}
...
get _multipliersRedirection$Action() {if(!(this.hasOwnProperty("__multipliersRedirection$Action"))) {
...
try {controller.ensureControllerAlive("MultipliersRedirection");
callContext = controller.callContext(callContext);
// Destination: /tradershub/
...
}set _multipliersRedirection$Action(value) {this.__multipliersRedirection$Action = value;
}
...
get _topupDemoAccount$Action() {if(!(this.hasOwnProperty("__topupDemoAccount$Action"))) {
...
}set _topupDemoAccount$Action(value) {this.__topupDemoAccount$Action = value;
}

get _filterAccountListAction$Action() {if(!(this.hasOwnProperty("__filterAccountListAction$Action"))) {
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_Options_mvc_controller_FilterAccountListAction_FilterAccountListJS, "FilterAccountList", "FilterAccountListAction", {
...
}set _filterAccountListAction$Action(value) {this.__filterAccountListAction$Action = value;
}

get _vanillaRedirection$Action() {if(!(this.hasOwnProperty("__vanillaRedirection$Action"))) {
...
try {controller.ensureControllerAlive("VanillaRedirection");
callContext = controller.callContext(callContext);
// Destination: /tradershub/
...
}set _vanillaRedirection$Action(value) {this.__vanillaRedirection$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._turbosRedirection$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._redirectToTrustPilot$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._toggleEmptyPlatformModal$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._androidDGoRedirection$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._accumulatorsRedirection$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._iOSDGoRedirection$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._multipliersRedirection$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._vanillaRedirection$Action, callContext);
} finally {
if(span) {
span.end();
}
